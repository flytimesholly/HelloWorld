...
static struct rt_i2c_bus_device *mpu6050_i2c_bus = RT_NULL;;    /* I2C设备句柄 */
...
//MPU6050硬件初始化
//返回值: 0,成功 / -1,错误代码
static void mpu6050_hw_init(const char *name)
{
    rt_uint8_t res;

    mpu6050_i2c_bus = rt_i2c_bus_device_find(name);  /*查找I2C设备*/
